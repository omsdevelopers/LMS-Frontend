...
// leads
const AddLeads = React.lazy(() => import('../pages/apps/Leads/'));
...
const leadAppRoutes: RoutesProps = {
    path: '/apps/add-leads',
    name: 'Add Leads',
    route: PrivateRoute,
    roles: ['Admin'],
...
const todayLeadAppRoutes: RoutesProps = {
    path: '/apps/today-leads',
    name: 'Today Leads',
    route: PrivateRoute,
    roles: ['Admin'],
    icon: 'calendar',
...
const leadSplitPaneAppRoutes: RoutesProps = {
    path: '/apps/split-pane',
    name: 'Today Leads',
    route: PrivateRoute,
    roles: ['Admin'],
    icon: 'calendar',
...
const scheduleLeadsAppRoutes: RoutesProps = {
    path: '/apps/schedule-leads',
    name: 'Today Leads',
    route: PrivateRoute,
    roles: ['Admin'],
    icon: 'calendar',
