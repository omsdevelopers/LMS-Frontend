...
const everyLeadsReducer = (
  state = initialState,
  action: { type: string; payload: any }
) => {
  switch (action.type) {
    case LeadsActionTypes.SET_EVERY_LEAD_COUNT:
      return {
        ...state,
        leadsCount: action.payload,
      };

    case LeadsActionTypes.FETCH_EVERY_LEAD_COUNT:
      return {
        ...state,
        loading: true,
      };
    ...
    case LeadsActionTypes.FETCHEVERY_LEAD:
      return {
        ...state,
        loading: true,
      };
...
export default everyLeadsReducer;
